...
def main():
	...
	#upload
	client.upload_file('DavidSchneiderResume.pdf', 'davidschneiderprojects', 'DavidSchneiderResume2.pdf', ExtraArgs={'ACL':'public-read', 'ContentType': 'application/pdf', 'ContentDisposition':'inline'})
